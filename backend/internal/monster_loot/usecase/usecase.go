...
func (s *MonsterLootService) CreateMonsterLoot(monsterLoot *entities.MonsterLoot) error {
...
func (s *MonsterLootService) PatchMonsterLoot(id string, monsterLoot *entities.MonsterLoot) error {

	// Need to use 2 primaryKey

	// if err := s.repo.Patch(id, monsterLoot); err != nil {
	// 	return err
	// }

	// // Update cache after patching
	// updatedMonsterLoot, err := s.repo.FindByID(id)
	// if err == nil {
...
func (s *MonsterLootService) DeleteMonsterLoot(id string) error {
	...
	// redisclient.Delete("monsterLoot:" + id)
